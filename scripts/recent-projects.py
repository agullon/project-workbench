#!/usr/bin/env python3
"""Show the most recently active projects, excluding done ones.

Used by the SessionStart hook to give Claude and the user context.
...
def main():
    ...
    for i, e in enumerate(top, 1):
        lines.append(
            f"  {i:<3} {e['name']:<30} {e['type']:<14} "
            f"{e['status']:<10} {e['date_str']}"
        )
    lines.append("")
